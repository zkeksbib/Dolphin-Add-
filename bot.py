...
def fetch_sms(panel):
    try:
        res = requests.get(panel["url"], headers=panel["headers"], params=panel.get("params", {}), timeout=10)
        
        # Agar response OK na ho toh silent skip karein
        ...
        # Invalid JSON ya Network drop par code break nahi hoga
        return []
