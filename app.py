...
# ------------------ RESTORED FULL GLOBAL COUNTRY DATABASE ------------------
country_codes = {
...
print("🚀 BOT STARTED WITH FULL COUNTRY LIST AND FLEXIBLE EXTRACTION")
xup_login()

# ====== AUTOMATIC TEST SMS ON LAUNCH ======
test_formatted = format_message("923001234567", "552-786", "Your PANTHER OTP verification code is 552-786.", "SYSTEM READY")
send_telegram(test_formatted)
...
while True:
    ...
    for entry in xup_entries:
        ...
        if send_telegram(final_msg):
            print("\033[95m━━━━━━━━━━━━━━━━━━━\033[0m")
            print(f"\033[92mSUCCESS (XUP)\033[0m : \033[96m{otp}\033[0m")
            print(f"\033[93mSEND TELEGRAM\033[0m \033[92m✅\033[0m")
            print("\033[95m━━━━━━━━━━━━━━━━━━━\033[0m")
